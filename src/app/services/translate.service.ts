...
const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  pl: {
    ...
    'profile.label_username': 'Nazwa użytkownika:',
    'profile.label_registered': 'Data rejestracji:',
    'profile.logout': 'Wyloguj się',
    'auth.login_title': 'Logowanie',
    'auth.login_demo_title': '🧪 Testowe konto:',
    'auth.field_email': 'Email',
    'auth.field_password': 'Hasło',
    'auth.field_username': 'Nazwa użytkownika',
    'auth.field_confirm_password': 'Potwierdź hasło',
    'auth.placeholder_email': 'twoj@email.pl',
    'auth.placeholder_username': 'Nazwa użytkownika',
    'auth.placeholder_password': 'Hasło',
    'auth.placeholder_password_min': 'Hasło (min. 6 znaków)',
    'auth.placeholder_confirm_password': 'Potwierdź hasło',
    'auth.login_submit': 'Zaloguj się',
    'auth.login_loading': 'Logowanie...',
    'auth.register_title': 'Rejestracja',
    'auth.register_demo_title': 'ℹ️ Aplikacja DEMO',
    'auth.register_demo_text':
      'To jest wersja demonstracyjna. Możesz utworzyć własne konto lub użyć testowego konta do logowania.',
    'auth.register_submit': 'Zarejestruj się',
    'auth.register_loading': 'Rejestrowanie...',
    'auth.footer_no_account': 'Nie masz konta?',
    'auth.footer_register': 'Zarejestruj się',
    'auth.footer_has_account': 'Masz już konto?',
    'auth.footer_login': 'Zaloguj się',
    'auth.lang_group_label': 'Język interfejsu',
    'auth.error_fill_fields': 'Wypełnij wszystkie pola',
    'auth.error_login_generic': 'Błąd logowania',
    'auth.error_register_generic': 'Błąd rejestracji',
    'auth.error_password_mismatch': 'Hasła nie są identyczne',
    'auth.error_password_short': 'Hasło musi mieć co najmniej 6 znaków',
    'auth.error_email_taken': 'Email już jest zarejestrowany',
    'auth.error_username_taken': 'Nazwa użytkownika już istnieje',
    'auth.error_invalid_credentials': 'Nieprawidłowy email lub hasło',
    'share.error_list_missing': 'Lista nie istnieje',
    'share.error_not_logged_in': 'Musisz być zalogowany',
    'share.error_not_owner': 'Możesz udostępniać tylko swoje listy',
  ...
  en: {
    ...
    'profile.label_registered': 'Registered:',
    'profile.logout': 'Log out',
    'auth.login_title': 'Sign in',
    'auth.login_demo_title': '🧪 Test account:',
    'auth.field_email': 'Email',
    ...
    'auth.placeholder_password_min': 'Password (min. 6 characters)',
    'auth.placeholder_confirm_password': 'Confirm password',
    'auth.login_submit': 'Sign in',
    'auth.login_loading': 'Signing in...',
    'auth.register_title': 'Create account',
    'auth.register_demo_title': 'ℹ️ Demo app',
    'auth.register_demo_text':
      'This is a demo. You can create your own account or use the test account to sign in.',
    'auth.register_submit': 'Sign up',
    'auth.register_loading': 'Signing up...',
    'auth.footer_no_account': "Don't have an account?",
    'auth.footer_register': 'Sign up',
    'auth.footer_has_account': 'Already have an account?',
    'auth.footer_login': 'Sign in',
    'auth.lang_group_label': 'Interface language',
    'auth.error_fill_fields': 'Please fill in all fields',
    'auth.error_login_generic': 'Sign-in failed',
    'auth.error_register_generic': 'Registration failed',
    ...
    'share.error_list_missing': 'List does not exist',
    'share.error_not_logged_in': 'You must be signed in',
    'share.error_not_owner': 'You can only share your own lists',
